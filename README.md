...
2. Unzip, then add the unzipped directory as an enviromental variable.
3. You're done! To compile a .gds file, type "gds -c [file directory]" in your command prompt.
